...
export const BASE_API_URL = "https://api.beatfilm.nomoredomainsrocks.ru";

export const TABLET_SCREEN = 900;
export const MOBILE_SCREEN = 480;

export const MOVIES_ROW_DESKTOP = 12;
export const MOVIES_ROW_TABLET = 8;
export const MOVIES_ROW_MOBILE = 5;
